...
1) Open celeryd in text editor & change the following variables
   ...
   .. _celeryd: https://github.com/marvin-2016/cdr-stats/raw/master/install/celery-init/etc/init.d/celeryd
...
2) Open celeryd (for periodic task) in text editor & add the following variables
   ...
   .. _celerybeat: https://github.com/marvin-2016/cdr-stats/raw/master/install/celery-init/etc/init.d/celerybeat
